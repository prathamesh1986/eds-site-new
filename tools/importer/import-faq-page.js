...
const PAGE_TEMPLATE = {
  name: 'faq-page',
  description: 'FAQ layout: hero header followed by an accordion of Q&A, a contact columns section, and a closing CTA.',
  urls: [
  ...
  blocks: [
    ...
    { name: 'section-contact', instances: ['#main-content > section.section.secondary-section'], section: 'secondary' },
    { name: 'section-cta', instances: ['#main-content > section.section.accent-section'], section: 'accent' },
  ],
  sections: [
    { id: 'rc1', name: 'FAQ hero header', selector: '#main-content > header.section.secondary-section', style: 'secondary', blocks: ['columns'], defaultContent: [] },
    { id: 'rc2', name: 'FAQ accordion', selector: '#main-content > section.section:nth-of-type(1)', style: null, blocks: ['accordion'], defaultContent: [] },
    { id: 'rc3', name: 'Lets connect', selector: '#main-content > section.section.secondary-section', style: 'secondary', blocks: ['columns'], defaultContent: [] },
